...
?>
    <div id="bloc">
        ...
        <div>
            ...
            <p><b>Firstname</b> : <?php echo strip_tags($_POST['firstname']); ?> <b> <i class="bi bi-check-lg"></i></b></p>
            <p><b>Surname</b> : <?php echo strip_tags( $_POST['lastname']); ?><b> <i class="bi bi-check-lg"></i></b></p>
            <p><b>Mail</b> : <?php echo strip_tags( $_POST['mail_add']); ?><b> <i class="bi bi-check-lg"></i></b></p>
            <p><b>Message</b> :
            <div class="message">
                 <?php echo strip_tags( $_POST['message']); ?></p>
            </div>
        </div>
    </div>
</body>
